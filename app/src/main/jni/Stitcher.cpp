...
Java_com_fx_android_watercamerademo_ImagesStitchUtil_stitchImages(JNIEnv *env, jclass type,
                                                        jobjectArray paths) {
    jstring jstr;
...
//    stitcher.setWaveCorrection(false);//波动修正
...
Java_com_fx_android_watercamerademo_ImagesStitchUtil_getMat(JNIEnv *env, jclass type, jlong mat) {
...
Java_com_fx_android_watercamerademo_ImagesStitchUtil_getBitmap(JNIEnv *env, jclass type, jobject bitmap) {
